...
const Model1708: NextPage = () => {
  return (
    <>
      <Head>
        <title>Residence 1708 Availability | Sierra at Skyeview Home Finder</title>
        <meta
          name="description"
        ...
        <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-16">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto mb-8">
              Use Dr. Jan Duffy's private home finder to follow every Residence 1708 release—pricing updates, incentives, construction milestones, photos, and lot status delivered straight from Century Communities.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                🔍 Explore Residence 1708 Availability
          ...
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-gray-50 rounded-lg shadow p-6">
                ...
                <p className="text-gray-600">Track which Residence 1708 homesites are released, reserved, or coming soon with real-time updates from Century Communities.</p>
              </div>
              <div className="bg-gray-50 rounded-lg shadow p-6">
