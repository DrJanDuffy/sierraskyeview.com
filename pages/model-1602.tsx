        ...
        <section className="py-12 bg-red-600 text-white">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-6">
              Dr. Jan Duffy represents YOU—not the builder. As your Buyer's Agent for the Sierra at Skyeview Area in Skye Canyon, she provides strategy, negotiation, and concierge support from first visit through closing. Located at 3,000+ foot elevation with access to Mount Charleston, this premier community offers a unique Las Vegas lifestyle.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
