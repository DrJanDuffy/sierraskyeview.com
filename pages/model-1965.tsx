          ...
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              ...
              <div className="bg-gray-50 rounded-lg shadow p-6">
                ...
                <p className="text-gray-600">Review pricing movements, builder incentives, elevation options, and fresh photo galleries curated by Dr. Jan.</p>
              </div>
              <div className="bg-gray-50 rounded-lg shadow p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Alerts & Private Tours</h3>
                <p className="text-gray-600">Schedule private tours, ask questions, or enable instant alerts when Residence 1965 inventory matches your criteria.</p>
              </div>
            </div>
            <div className="mt-10">
              <a
        ...
        <section className="py-16 bg-red-600 text-white">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8">
              Dr. Jan Duffy is your independent advocate—guiding design selections, negotiating incentives, and managing the build through closing.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
